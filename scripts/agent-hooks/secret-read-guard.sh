...
#     cannot match: SECRET_PATTERNS anchors on the start of the token or on `/` or `=`, and a
#     space is neither — while `cat "my dir/.env"` still matches on the slash.
