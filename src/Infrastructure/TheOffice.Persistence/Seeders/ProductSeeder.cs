...
{
  // Fuente unica de los 16 productos sembrados: ProductImageSeeder deriva de aqui la URL
  // de la foto que cada uno tenia antes de que ImageUrl saliera del modelo.
  ...
  internal static IReadOnlyList<Product> SeededProducts => Catalog;

  public static void SeedProductsConfig(this ModelBuilder modelBuilder)
  {
    modelBuilder.Entity<Product>().HasData(Catalog);
  }
